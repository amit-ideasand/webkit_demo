...
class SyncfusionChartsController extends MyController {
  ...
  final TooltipBehavior dashedSpLine = TooltipBehavior(enable: true, format: 'point.x : point.y');
  ...
  final TooltipBehavior rangeSlider = TooltipBehavior(enable: true, format: 'point.x : point.high : point.low');
  ...
  final TooltipBehavior vertical = TooltipBehavior(enable: true, format: 'point.x : point.y  ');
  ...
  final TooltipBehavior gradient = TooltipBehavior(enable: true, format: 'point.x : point.y ');
  ...
  final List<ChartSampleData> radialChartData = <ChartSampleData>[
    ...
    ChartSampleData(x: 'Jon', y: 14, text: '100%', pointColor: const Color.fromRGBO(23, 300, 120, 1.0)),
  ];
  final TooltipBehavior radialTooltipBehavior = TooltipBehavior(enable: true, format: 'point.x : point.ym');
