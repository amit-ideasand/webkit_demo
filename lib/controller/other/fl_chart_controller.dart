...
class FlChartController extends MyController {
  ...
  LineTouchData get lineTouchData1 => LineTouchData(
      handleBuiltInTouches: true, touchTooltipData: LineTouchTooltipData());
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    return SideTitleWidget(/*axisSide: meta.axisSide*/ space: 10, meta: meta,
    child: text);
  }
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
        ...
        dotData: const FlDotData(show: false),
        belowBarData:
            BarAreaData(show: false, color: Colors.pink.withValues(alpha: 0)),
        spots: const [
          FlSpot(1, 1),
          FlSpot(3, 2.8),
          FlSpot(7, 1.2),
  ...
  LineChartBarData sinLine(List<FlSpot> points) {
    return LineChartBarData(
        ...
        dotData: const FlDotData(show: false),
        gradient: LinearGradient(
            colors: [Colors.blue.withValues(alpha:0), Colors.blue],
            stops: const [0.1, 1.0]),
        barWidth: 4,
        isCurved: false);
  }
  ...
  LineChartBarData cosLine(List<FlSpot> points) {
    return LineChartBarData(
        ...
        dotData: const FlDotData(show: false),
        gradient: LinearGradient(
            colors: [Colors.pink.withValues(alpha:0), Colors.pink],
            stops: const [0.1, 1.0]),
        barWidth: 4,
        isCurved: false);
  }
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    return SideTitleWidget(
        /*axisSide: meta.axisSide,*/ space: 4, meta: meta,
