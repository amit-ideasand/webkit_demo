...
class _MyOnBoardingState extends State<MyOnBoarding> with TickerProviderStateMixin {
      ...
      setState(() {
        if (event.updateType == UpdateType.dragging) {
          ...
          animatedPageDragger = AnimatedPageDragger(
            ...
            transitionGoal: slidePercent > 0.5 ? TransitionGoal.open : TransitionGoal.close,
