      ...
      child: Wrap(
        ...
        children: [
          ...
          MyButton.outlined(
            ...
            splashColor: contentTheme.success.withValues(alpha:0.1),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'success'.tr(),
          ...
          MyButton.outlined(
            ...
            splashColor: contentTheme.warning.withValues(alpha:0.1),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'warning'.tr(),
          ...
          MyButton.outlined(
            ...
            splashColor: contentTheme.info.withValues(alpha:0.1),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'info'.tr(),
          ...
          MyButton.outlined(
            ...
            splashColor: contentTheme.danger.withValues(alpha:0.1),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'danger'.tr(),
      ...
      child: Wrap(
        ...
        children: [
          ...
          MyButton(
            ...
            padding: MySpacing.xy(20, 16),
            borderColor: contentTheme.success,
            backgroundColor: contentTheme.success.withValues(alpha:0.12),
            splashColor: contentTheme.success.withValues(alpha:0.2),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'success'.tr(),
              color: contentTheme.success,
          ...
          MyButton(
            ...
            padding: MySpacing.xy(20, 16),
            borderColor: contentTheme.warning,
            backgroundColor: contentTheme.warning.withValues(alpha:0.12),
            splashColor: contentTheme.warning.withValues(alpha:0.2),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'warning'.tr(),
              color: contentTheme.warning,
          ...
          MyButton(
            ...
            padding: MySpacing.xy(20, 16),
            borderColor: contentTheme.info,
            backgroundColor: contentTheme.info.withValues(alpha:0.12),
            splashColor: contentTheme.info.withValues(alpha:0.2),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'info'.tr(),
              color: contentTheme.info,
          ...
          MyButton(
            ...
            padding: MySpacing.xy(20, 16),
            borderColor: contentTheme.danger,
            backgroundColor: contentTheme.danger.withValues(alpha:0.12),
            splashColor: contentTheme.danger.withValues(alpha:0.2),
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(
              'danger'.tr(),
              color: contentTheme.danger,
