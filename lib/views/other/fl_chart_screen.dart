...
class _FlChartScreenState extends State<FlChartScreen> with SingleTickerProviderStateMixin, UIMixin {
                  ...
                  children: [
                      ...
                      child: MyContainer.bordered(
                        child: Column(
                          children: [
                            ...
                            SizedBox(
                              height: 300,
                              child: LineChart(controller.sampleData, duration: Duration(milliseconds: 600)),
                            ),
                          ],
                        ),
                      ),
                      ...
                      child: controller.cosPoints.isNotEmpty
                          ? MyContainer.bordered(
                              child: Column(
                                ...
                                children: [
                                  Center(child: MyText.bodyMedium('Line Chart 3', fontWeight: 600)),
                                  MySpacing.height(8),
                                  MyText.bodyMedium(
                                  ...
                                  SizedBox(
                                    ...
                                    child: LineChart(
                                      LineChartData(
                                        ...
                                        lineBarsData: [
                                          controller.sinLine(controller.sinPoints),
                                          controller.cosLine(controller.cosPoints),
                                        ],
                                  ...
                                  barTouchData: BarTouchData(
                                    ...
                                    touchCallback: (FlTouchEvent event, response) {
                                      if (response == null || response.spot == null) {
                                        ...
                                        controller.showingBarGroups = List.of(controller.rawBarGroups);

                                        return;
                                      }

                                      controller.touchedGroupIndex = response.spot!.touchedBarGroupIndex;
                                      ...
                                      if (controller.touchedGroupIndex != -1) {
                                        var sum = 0.0;
                                        for (final rod in controller.showingBarGroups[controller.touchedGroupIndex].barRods) {
                                          sum += rod.toY;
                                        }
                                        final avg = sum / controller.showingBarGroups[controller.touchedGroupIndex].barRods.length;

                                        controller.showingBarGroups[controller.touchedGroupIndex] =
                                            controller.showingBarGroups[controller.touchedGroupIndex].copyWith(
                                          barRods: controller.showingBarGroups[controller.touchedGroupIndex].barRods.map((rod) {
                                            return rod.copyWith(
                                              toY: avg,
                              ...
                              child: BarChart(
                                BarChartData(
                                  ...
                                  barGroups: [
                                    ...
                                    controller.generateGroupData(2, 1.3, 3.1, 2.8),
                                    controller.generateGroupData(3, 3.1, 4, 3.1),
                                    controller.generateGroupData(4, 0.8, 3.3, 3.4),
                                    controller.generateGroupData(5, 2, 5.6, 1.8),
                                    controller.generateGroupData(6, 1.3, 3.2, 2),
                                    controller.generateGroupData(7, 2.3, 3.2, 3),
                                    controller.generateGroupData(8, 2, 4.8, 2.5),
                                    controller.generateGroupData(9, 1.2, 3.2, 2.5),
                                    controller.generateGroupData(10, 1, 4.8, 3),
                                    controller.generateGroupData(11, 2, 4.4, 2.8),
                                  ],
                                ...
                                PieChartData(
                                  pieTouchData: PieTouchData(
                                    touchCallback: (FlTouchEvent event, pieTouchResponse) {
                                      ...
                                      controller.touchedIndex1 = pieTouchResponse.touchedSection!.touchedSectionIndex;
                                    },
                                  ),
                                ...
                                PieChartData(
                                  pieTouchData: PieTouchData(
                                    touchCallback: (FlTouchEvent event, pieTouchResponse) {
                                      ...
                                      controller.touchedIndex2 = pieTouchResponse.touchedSection!.touchedSectionIndex;
                                    },
                                  ),
                                  borderData: FlBorderData(
                                    show: false,
                                ...
                                PieChartData(
                                  pieTouchData: PieTouchData(
                                    touchCallback: (FlTouchEvent event, pieTouchResponse) {
                                      ...
                                      controller.touchedIndex3 = pieTouchResponse.touchedSection!.touchedSectionIndex;
                                    },
                                  ),
                                  borderData: FlBorderData(
                                    show: false,
                    ...
                    MyFlexItem(
                      ...
                      child: MyContainer.bordered(
                        child: Column(
                          children: [
                            MyText.bodyMedium('Scatter Chart 1', fontWeight: 600),
                            MySpacing.height(8),
                            SizedBox(
                              height: 500,
                              child: InkWell(
                                ...
                                child: ScatterChart(
                                  ScatterChartData(
                                    scatterSpots: controller.showFlutter ? controller.flutterLogoData() : controller.randomData(),
                                    minX: 0,
                    ...
                    MyFlexItem(
                      ...
                      child: MyContainer.bordered(
                        child: Column(
                          children: [
                            MyText.bodyMedium('Scatter Chart 2', fontWeight: 600),
                            MySpacing.height(8),
                            SizedBox(
                              height: 500,
                              child: ScatterChart(
                                ScatterChartData(
                                  ...
                                  gridData: FlGridData(
                                    ...
                                    getDrawingVerticalLine: (value) => const FlLine(color: Colors.black12
                                        // color: Colors.gridLinesColor,
                                        ),
                                  ),
                                  titlesData: const FlTitlesData(
                                  ...
                                  showingTooltipIndicators: controller.selectedSpots,
                                  scatterTouchData: ScatterTouchData(
                                    enabled: true,
                                    ...
                                    touchCallback: (FlTouchEvent event, ScatterTouchResponse? touchResponse) {
                                      ...
                                      if (event is FlTapUpEvent) {
                                        ...
                                        if (controller.selectedSpots.contains(sectionIndex)) {
                                          controller.selectedSpots.remove(sectionIndex);
                                        } else {
                                          controller.selectedSpots.add(sectionIndex);
                                        }
                                      }
                                    },
                                  ),
                    ...
                    MyFlexItem(
                      ...
                      child: MyContainer.bordered(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Center(child: MyText.bodyMedium('Radar Chart', fontWeight: 600)),
                            MySpacing.height(8),
                            GestureDetector(
                              onTap: () {
                              ...
                              children: controller
                                  ...
                                  .map((index, value) {
                                    ...
                                    return MapEntry(
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          controller.selectedDataSetIndex = index;
                                        },
                                ...
                                RadarChartData(
                                  radarTouchData: RadarTouchData(
                                    touchCallback: (FlTouchEvent event, response) {
                                      ...
                                      controller.selectedDataSetIndex = response?.touchedSpot?.touchedDataSetIndex ?? -1;
                                    },
                                  ),
                                  ...
                                  getTitle: (index, angle) {
                                    final usedAngle = controller.relativeAngleMode ? angle + controller.angleValue : controller.angleValue;
                                    switch (index) {
                                      case 0:
