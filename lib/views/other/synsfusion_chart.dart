...
class _SyncFusionChartState extends State<SyncFusionChart> with SingleTickerProviderStateMixin, UIMixin {
                              ...
                              series: [
                                AreaSeries<ChartSampleData, String>(
                                  ...
                                  onCreateShader: (ShaderDetails details) {
                                    return ui.Gradient.linear(details.rect.bottomLeft, details.rect.bottomRight, <Color>[
                        ...
                        child: Column(
                          children: [
                            ...
                            SfCartesianChart(
                                ...
                                primaryXAxis: NumericAxis(majorGridLines: const MajorGridLines(width: 0), minimum: 60, maximum: 100),
                                  ...
                                  SfCartesianChart(
                                    ...
                                    series: [
                                      SplineSeries<ChartSampleData, String>(
                                        color: contentTheme.primary,
                                        dataSource: controller.verticalSpLineChart,
                                        xValueMapper: (ChartSampleData data, _) => data.x,
                                        yValueMapper: (ChartSampleData data, _) => data.y,
                                      ),
                                    ],
                                  ...
                                  SfCartesianChart(
                                    ...
                                    series: [
                                      SplineSeries<ChartSampleData, int>(
                                        color: contentTheme.primary,
                                        dataSource: controller.dashedSpLineChart,
                    ...
                    MyFlexItem(
                        ...
                        child: MyContainer(
                          ...
                          children: [
                            ...
                            MySpacing.height(flexSpacing),
                            SfCartesianChart(primaryXAxis: CategoryAxis(), tooltipBehavior: controller.rangeSlider, series: [
                        ...
                        child: MyContainer(
                          child: Column(
                            children: [
                              ...
                              MySpacing.height(flexSpacing),
                              SfPyramidChart(
                                title: ChartTitle(text: 'comparison_of_calories'.tr(), textStyle: MyTextStyle.bodySmall()),
                                tooltipBehavior: TooltipBehavior(enable: true),
