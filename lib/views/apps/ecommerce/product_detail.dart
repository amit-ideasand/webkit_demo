...
import 'package:webkit/controller/apps/ecommerce/product_detail_controller.dart';
...
class _ProductDetailState extends State<ProductDetail> with SingleTickerProviderStateMixin, UIMixin {
                              ...
                              children: controller.images
                                  .mapIndexed(
                                    (index, images) => MyContainer.bordered(
                                      ...
                                      height: 100,
                                      bordered: images == controller.selectedImage,
                                      border: Border.all(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      MyContainer(
                                        color: !controller.showLike ? contentTheme.red.withAlpha(30) : contentTheme.dark.withAlpha(30),
                                        paddingAll: 0,
                                        clipBehavior: Clip.antiAliasWithSaveLayer,
                                        child: IconButton(
                                          onPressed: () {
                                          ...
                                          icon: Icon(!controller.showLike ? Icons.favorite_outlined : LucideIcons.heart,
                                              size: 24, color: !controller.showLike ? contentTheme.red : contentTheme.dark),
                                        ),
                                      ),
                                      MySpacing.width(16),
                                      MyContainer(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        MyButton(
                                          ...
                                          splashColor: contentTheme.secondary.withValues(alpha: 0.2),
                                          borderRadiusAll: AppStyle.buttonRadius.medium,
                                          child: MyText.bodySmall(
                                            'Add To Cart',
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: MyContainer.bordered(
                                    ...
                                    child: DataTable(
                                      sortAscending: true,
                                      onSelectAll: (value) {},
                                      headingRowColor: WidgetStatePropertyAll(contentTheme.primary.withAlpha(30)),
                                      columns: [
                                        DataColumn(
                                      ...
                                      rows: [
                                        buildDataRows("ASOS Radley Outlet - NYC", "\$584.11", 0.2, "\$5,84,445"),
                                        buildDataRows("Marco Outlet - SRT", "\$123.06", 0.1, "\$15,84,445"),
                                        buildDataRows("Chastest Outlet - HY", "\$452.00", 0.5, "\$12,84,445"),
                                        buildDataRows("World Group - India", "\$120.00", 0.8, "\$16,84,445"),
                                      ],
                                    ),
                                  ),
                                ),
  ...
  DataRow buildDataRows(String outLets, String price, dynamic stock, String revenue) {
    return DataRow(
      cells: [
        DataCell(
          SizedBox(
