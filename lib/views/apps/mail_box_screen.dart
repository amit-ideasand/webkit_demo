        ...
        Expanded(
          child: Wrap(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {}, child: Icon(LucideIcons.refresh_cw, size: 18)),
              InkWell(
                  onTap: () {},
                  child: Icon(LucideIcons.archive_restore, size: 18)),
              InkWell(onTap: () {}, child: Icon(LucideIcons.info, size: 18)),
              InkWell(
                  onTap: () => controller.removeData(),
                  child: Icon(LucideIcons.trash_2, size: 18)),
              InkWell(onTap: () {}, child: Icon(LucideIcons.mail, size: 18)),
              InkWell(onTap: () {}, child: Icon(LucideIcons.tag, size: 18)),
              InkWell(onTap: () {}, child: Icon(LucideIcons.clock_4, size: 18)),
            ],
          ),
        ),
        Expanded(
  ...
  Widget buildMailMenu() {
    ...
    return Column(
      ...
      children: [
        ...
        MySpacing.height(16),
        menuItem(LucideIcons.square_equal, 'Draft'),
        MySpacing.height(16),
        menuItem(LucideIcons.step_forward, 'Important'),
        MySpacing.height(16),
        menuItem(LucideIcons.octagon_alert, 'Spam'),
        MySpacing.height(16),
        menuItem(LucideIcons.circle_user, 'Contact'),
        MySpacing.height(16),
        menuItem(LucideIcons.trash_2, 'Trash'),
        MySpacing.height(20),
        MyText.titleMedium("CATEGORY", fontWeight: 600),
        MySpacing.height(20),
        menuItem(LucideIcons.radio_tower, 'Social'),
        MySpacing.height(16),
        menuItem(LucideIcons.squirrel, 'Updates'),
        MySpacing.height(16),
        menuItem(LucideIcons.file_text, 'Forms'),
        MySpacing.height(16),
