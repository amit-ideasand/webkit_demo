...
class _FitnessScreenState extends State<FitnessScreen> with SingleTickerProviderStateMixin, UIMixin {
        ...
        builder: (controller) {
          final bool enableMultiView = controller.isClosed &&
              (controller.selectionMode == DateRangePickerSelectionMode.range ||
                  controller.selectionMode == DateRangePickerSelectionMode.multiRange ||
                  controller.selectionMode == DateRangePickerSelectionMode.extendableRange);
                      ...
                      child: MyFlex(
                        ...
                        children: [
                                      ...
                                      PopupMenuButton(
                                        ...
                                        child: MyContainer(
                                          ...
                                          child: Row(
                                            ...
                                            children: <Widget>[
                                              MyText.labelMedium(
                                                controller.selectedActivity.toString(),
                                                color: theme.colorScheme.onSurface,
                                              ),
                                              Icon(
                          ...
                          MyFlexItem(
                              sizes: 'lg-4',
                              child: MyContainer(
                                child: SizedBox(height: 338, child: _buildAngleRadialBarChart()),
                              )),
                          MyFlexItem(
                            child: MyContainer(
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      MyText.bodyMedium("Recommended Food", textAlign: TextAlign.end, fontWeight: 600),
                                      PopupMenuButton(
                                        ...
                                        child: MyContainer(
                                          ...
                                          child: Row(
                                            ...
                                            children: <Widget>[
                                              MyText.labelMedium(
                                                controller.selectedFood.toString(),
                                                color: theme.colorScheme.onSurface,
                                              ),
                                              Icon(
                                                LucideIcons.chevron_down,
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView(
                                      ...
                                      scrollDirection: Axis.horizontal,
                                      children: [
                                        buildRecommendedFood(Images.veggies, 'Fresh Veggies', '7 Days', 'Only dinner time'),
                                        MySpacing.width(16),
                                        buildRecommendedFood(Images.fruits, 'Fresh Fruits', '12 Days', 'Only Lunch time'),
                                        MySpacing.width(16),
                                        buildRecommendedFood(Images.fruitsJuice, 'Fresh Fruits Juice', '7 Days', 'Only BreakFast time'),
                                      ],
                                    ),
                                  )
                                ],
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView(
                                            ...
                                            shrinkWrap: true,
                                            children: [
                                              buildTrainer(Images.avatars[0], 'Jack Amanda', 'Gym Expert'),
                                              MySpacing.width(12),
                                              buildTrainer(Images.avatars[2], 'Olive Yew', 'Yoga Expert'),
                                            ],
                                          ),
                                        )
                                      ],
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            PopupMenuButton(
                                              onSelected: controller.onSelectedOutPut,
                                              itemBuilder: (BuildContext context) {
                                                return ["Year", "Month", "Week", "Day", "Hours"].map((behavior) {
                                                  return PopupMenuItem(
                                                    value: behavior,
                                              ...
                                              child: MyContainer(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: <Widget>[
                                                    MyText.labelMedium(controller.selectedOutPut.toString(), color: theme.colorScheme.onSurface),
                                                    Icon(LucideIcons.chevron_down, size: 22, color: theme.colorScheme.onSurface)
                                                  ],
                                                ),
                                              ),
                                            ),
                                        ...
                                        MySpacing.height(12),
                                        buildOutPut(contentTheme.primary, LucideIcons.rocket, 'Boost energy', '.125 gm', '😊 WOW'),
                                        MySpacing.height(16),
                                        buildOutPut(contentTheme.success, LucideIcons.dumbbell, 'Weight Loos', '3 Kg', '😇 Great')
                                      ],
                                    ),
                                  ),
                                ),
  ...
  Widget buildOutPut(Color color, IconData icon, String title, String weight, String emoji) {
    return MyContainer(
  ...
  SfDateRangePicker getGettingStartedDatePicker(
    ...
    return SfDateRangePicker(
      ...
      monthViewSettings: DateRangePickerMonthViewSettings(
          ...
          weekNumberStyle: DateRangePickerWeekNumberStyle(textStyle: MyTextStyle.bodyMedium()),
  ...
  Widget buildRecommendedFood(String image, String title, String days, String time) {
    return SizedBox(
      height: 130,
      width: 300,
      child: Stack(
  ...
  SfCircularChart _buildAngleRadialBarChart() {
    return SfCircularChart(
      title: ChartTitle(text: 'Today Activity', textStyle: MyTextStyle.bodySmall(fontWeight: 600)),
      legend: Legend(isVisible: true, iconHeight: 20, iconWidth: 20, position: LegendPosition.right, overflowMode: LegendItemOverflowMode.none),
      series: controller.getRadialBarSeries(),
    );
  }

  Widget buildWorkoutCategory(Color color, IconData icon, String title, String subTitle) {
    return SizedBox(
      height: 120,
      width: 250,
      child: Stack(
